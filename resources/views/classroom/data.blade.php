                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="{{ route('classroom.create') }}" class="btn btn-primary btn-sm">Tambah Kelas <i class="fa fa-plus fs-6"></i></a>
                            </div>
                        </div>
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form id="delete-form-{{ $item->id }}" action="{{ route('classroom.destroy', $item->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <a href="{{ route('classroom.edit', $item->id) }}" class="btn btn-warning btn-sm">Ubah</a>
